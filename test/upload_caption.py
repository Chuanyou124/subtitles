...
def list_captions(youtube, video_id):
  ...
  for item in results["items"]:
    ...
    print("Caption track '{}({})' in '{}' language.".format(name, id, language))
...
def download_caption(youtube, caption_id, tfmt):
  ...
  print("First line of caption track: {}".format(subtitle))
...
def delete_caption(youtube, caption_id):
  ...
  print("caption track {} deleted succesfully".format(caption_id))
